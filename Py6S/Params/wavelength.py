...
class PredefinedWavelengths:
    ...
    # Redefined the MODIS TERRA and AQUA passbands to a more accurate spectral
    # sampling that the default sixs, and also added the ocean bands
    ...
    ACCURATE_MODIS_AQUA_8_RSR_412 = (43, 0.40250, 0.51250,
                                     np.array(
                                         [0.08203, 0.52331, 0.62400, 0.75671,
                                          0.51767,
                                          0.84058, 0.90802, 0.33716, 0.03201,
                                          0.01067, 0.01170,
                                          0.01029,
                                          ]))
