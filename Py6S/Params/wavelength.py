...
class PredefinedWavelengths:
    ...
    # the mean dataset
    S3A_OLCI_01 = (66, 0.387524, 0.412524, 
                    np.array([0.00000000e+00,1.59064467e-03,3.97137636e-01,
                    6.65451665e-01,7.81167195e-01,9.03944327e-01,
                    9.59807590e-01,9.99043701e-01,2.05634933e-01,
                    6.33029663e-05,0.00000000e+00]))

    S3A_OLCI_02 = (67, 0.402476, 0.422476, 
                    np.array([0.00000000e+00,5.19015146e-03,7.70860678e-01,
                    9.92245979e-01,9.98234212e-01,9.65412807e-01,
                    1.69945823e-01,4.02925850e-05,0.00000000e+00]))

    S3A_OLCI_03 = (68, 0.432431, 0.452431, 
                    np.array([0.00000000e+00,6.58084120e-05,2.21598757e-01,
                    9.83663036e-01,9.98737752e-01,9.95989507e-01,
                    7.56084378e-01,4.19925111e-03,0.00000000e+00]))

    S3A_OLCI_04 = (69, 0.480823, 0.500823, 
                    np.array([0.00000000e+00,2.56325529e-03,6.80319199e-01,
                    9.72867951e-01,9.82166551e-01,9.98960077e-01,
                    3.06438746e-01,1.28327264e-04,0.00000000e+00]))

    S3A_OLCI_05 = (70, 0.500792, 0.520792, 
                    np.array([0.00000000e+00,2.34732080e-03,6.68045328e-01,
                    9.76351224e-01,9.90410784e-01,9.98893201e-01,
                    3.01511915e-01,1.20416873e-04,0.00000000e+00]))

    S3A_OLCI_06 = (71, 0.549863, 0.569863, 
                    np.array([0.00000000e+00,4.78626736e-05,2.12590672e-01,
                    9.84029792e-01,9.93860684e-01,9.99276042e-01,
                    7.94866927e-01,5.17630229e-03,0.00000000e+00]))

    S3A_OLCI_07 = (72, 0.610746, 0.630746, 
                    np.array([0.00000000e+00,2.11462268e-03,6.71523189e-01,
                    9.81569678e-01,9.90076814e-01,9.98634576e-01,
                    2.91879916e-01,1.02304010e-04,0.00000000e+00]))

    S3A_OLCI_08 = (73, 0.655712, 0.675712, 
                    np.array([0.00000000e+00,3.06277417e-03,7.32472784e-01,
                    9.86135569e-01,9.94636295e-01,9.98586953e-01,
                    2.53058825e-01,6.33997774e-05,0.00000000e+00]))

    S3A_OLCI_09 = (74, 0.664629, 0.682129, 
                    np.array([0.00000000e+00,2.96054568e-05,1.84284335e-01,
                    9.87690850e-01,9.98551965e-01,8.28395176e-01,
                    6.11439343e-03,3.58153317e-08]))

    S3A_OLCI_10 = (75, 0.673233, 0.690733, 
                    np.array([0.00000000e+00,2.82028691e-03,7.31663641e-01,
                    9.89987899e-01,9.98435974e-01,2.77351259e-01,
                    7.90877296e-05,0.00000000e+00]))

    S3A_OLCI_11 = (76, 0.698540, 0.718540, 
                    np.array([0.00000000e+00,3.54852394e-05,2.06664391e-01,
                    9.92309474e-01,9.98702927e-01,9.99332666e-01,
                    8.01786801e-01,4.30162969e-03,0.00000000e+00]))

    S3A_OLCI_12 = (77, 0.746070, 0.763570, 
                    np.array([1.96183241e-08,5.17658542e-03,8.27877517e-01,
                    9.99618410e-01,9.89007369e-01,1.77721815e-01,
                    2.09049742e-05,0.00000000e+00]))

    S3A_OLCI_13 = (78, 0.756702, 0.769202, 
                    np.array([7.04313922e-07,3.81363256e-02,9.99993679e-01,
                    4.44148108e-02,9.41929115e-07,0.00000000e+00]))

    S3A_OLCI_14 = (79, 0.759798, 0.772298, 
                    np.array([1.61109576e-05,1.62470897e-01,9.99993323e-01,
                    1.82980702e-01,2.15733279e-05,0.00000000e+00]))

    S3A_OLCI_15 = (80, 0.762886, 0.775386, 
                    np.array([6.16548013e-07,3.60342803e-02,9.99966860e-01,
                    4.27874034e-02,8.65161097e-07,0.00000000e+00]))

    S3A_OLCI_16 = (81, 0.766075, 0.791075, 
                    np.array([0.00000000e+00,2.00241544e-05,1.75418501e-01,
                    9.67850363e-01,9.81666110e-01,9.90971787e-01,
                    9.99985814e-01,9.96943966e-01,8.34733321e-01,
                    5.29120266e-03,1.73263453e-08]))

    S3A_OLCI_17 = (82, 0.850064, 0.880064, 
                    np.array([0.00000000e+00,2.93477359e-05,2.21163859e-01,
                    9.98840271e-01,9.91560353e-01,9.81730664e-01,
                    9.71571909e-01,9.59259563e-01,9.46902669e-01,
                    9.34619223e-01,7.33323300e-01,2.67009500e-03,
                    0.00000000e+00]))

    S3A_OLCI_18 = (83, 0.873798, 0.893798, 
                    np.array([0.00000000e+00,2.29030228e-05,1.99996060e-01,
                    9.98886821e-01,9.87830408e-01,9.73264556e-01,
                    7.74045115e-01,3.07928989e-03,0.00000000e+00]))

    S3A_OLCI_19 = (84, 0.888814, 0.908814, 
                    np.array([0.00000000e+00,2.49347261e-05,1.99925872e-01,
                    9.99127448e-01,9.84657900e-01,9.66294361e-01,
                    7.64075394e-01,3.07264394e-03,0.00000000e+00]))

    S3A_OLCI_20 = (85, 0.926245, 0.956245, 
                    np.array([2.32938920e-05,1.67056984e-01,9.99167082e-01,
                    9.66758463e-01,9.30372860e-01,8.94741550e-01,
                    8.63903862e-01,8.42288480e-01,8.22080507e-01,
                    6.88064240e-01,4.86425378e-03,4.32368935e-08,
                    0.00000000e+00]))

    S3A_OLCI_21 = (86, 0.996186, 1.046186, 
                    np.array([5.57523066e-05,1.37391763e-01,9.97605800e-01,
                    9.47751210e-01,8.88853823e-01,8.30899845e-01,
                    7.73577385e-01,7.16685293e-01,6.59881582e-01,
                    6.04045408e-01,5.61354651e-01,5.31903890e-01,
                    5.02472711e-01,4.73663292e-01,4.45619919e-01,
                    4.18228751e-01,3.91317067e-01,3.09936754e-01,
                    4.41224970e-03,6.24077291e-07,0.00000000e+00]))
    ...
    # band rsr from https://sentinel.esa.int/web/sentinel/technical-guides/sentinel-3-olci/olci-instrument/spectral-response-function-data
    # the mean dataset
    S3B_OLCI_01 = (93, 0.387719, 0.412719, 
                    np.array([0.00000000e+00,2.81552738e-04,3.64316674e-01,
                    5.94091091e-01,7.44356131e-01,9.05504496e-01,
                    9.58087487e-01,9.99850750e-01,1.22092455e-01,
                    1.08582956e-06,0.00000000e+00]))

    S3B_OLCI_02 = (94, 0.402548, 0.422548, 
                    np.array([0.00000000e+00,1.46895222e-03,8.00072771e-01,
                    9.88238809e-01,9.99129236e-01,9.87243596e-01,
                    1.48233468e-01,2.45110348e-06,0.00000000e+00]))

    S3B_OLCI_03 = (95, 0.433588, 0.453588, 
                    np.array([0.00000000e+00,2.26449099e-03,8.00795028e-01,
                    9.99513984e-01,9.92628539e-01,9.78478508e-01,
                    1.78944518e-01,7.58187218e-06,0.00000000e+00]))

    S3B_OLCI_04 = (96, 0.480837, 0.500837, 
                    np.array([0.00000000e+00,2.12317109e-03,7.35184835e-01,
                    9.84304651e-01,9.89844285e-01,9.99628722e-01,
                    2.49984490e-01,2.67005869e-05,0.00000000e+00]))

    S3B_OLCI_05 = (97, 0.500824, 0.520824, 
                    np.array([0.00000000e+00,2.17746796e-03,7.23247277e-01,
                    9.75687011e-01,9.87547404e-01,9.99615429e-01,
                    2.51257695e-01,2.84845052e-05,0.00000000e+00]))

    S3B_OLCI_06 = (98, 0.550722, 0.570722, 
                    np.array([0.00000000e+00,1.52416098e-03,6.98732750e-01,
                    9.90793923e-01,9.95490842e-01,9.99495625e-01,
                    2.95327250e-01,4.32422750e-05,0.00000000e+00]))

    S3B_OLCI_07 = (99, 0.610713, 0.630713, 
                    np.array([0.00000000e+00,1.63004502e-03,7.22375190e-01,
                    9.82323622e-01,9.90148859e-01,9.99636291e-01,
                    2.35792464e-01,1.75305683e-05,0.00000000e+00]))

    S3B_OLCI_08 = (100, 0.655569, 0.675569, 
                    np.array([0.00000000e+00,1.56800157e-03,7.41421945e-01,
                    9.85619018e-01,9.93781266e-01,9.99472260e-01,
                    2.38845666e-01,1.42551411e-05,0.00000000e+00]))

    S3B_OLCI_09 = (101, 0.666970, 0.684470, 
                    np.array([5.39819996e-06,1.65729034e-01,9.89321566e-01,
                    9.99181628e-01,8.38995850e-01,3.30005386e-03,
                    1.57922531e-09,0.00000000e+00]))

    S3B_OLCI_10 = (102, 0.672072, 0.689572, 
                    np.array([0.00000000e+00,8.72573836e-06,2.01042755e-01,
                    9.94129848e-01,9.99531984e-01,8.12019140e-01,
                    2.35068054e-03,0.00000000e+00]))

    S3B_OLCI_11 = (103, 0.698401, 0.718401, 
                    np.array([0.00000000e+00,7.04232874e-06,1.93116232e-01,
                    9.88471209e-01,9.94223391e-01,9.99736130e-01,
                    8.16092530e-01,2.26636100e-03,0.00000000e+00]))

    S3B_OLCI_12 = (104, 0.745916, 0.763416, 
                    np.array([1.13638471e-09,2.92221622e-03,8.42692621e-01,
                    9.99800025e-01,9.95600558e-01,1.64250283e-01,
                    4.22004883e-06,0.00000000e+00]))

    S3B_OLCI_13 = (105, 0.756532, 0.769032, 
                    np.array([7.37374323e-08,2.81444680e-02,9.99972165e-01,
                    3.39225479e-02,1.07860783e-07,0.00000000e+00]))

    S3B_OLCI_14 = (106, 0.757223, 0.772223, 
                    np.array([0.00000000e+00,5.15851496e-06,1.78783607e-01,
                    9.99921441e-01,1.55377428e-01,3.60333221e-06,
                    0.00000000e+00]))

    S3B_OLCI_15 = (107, 0.762796, 0.775296, 
                    np.array([7.31379926e-08,2.78876910e-02,9.99960473e-01,
                    3.34738620e-02,1.05477296e-07,0.00000000e+00]))

    S3B_OLCI_16 = (108, 0.767237, 0.792237, 
                    np.array([1.27186720e-09,3.04809356e-03,8.45518609e-01,
                    9.98200528e-01,9.98386680e-01,9.98066755e-01,
                    9.96503731e-01,9.91140659e-01,1.57061945e-01,
                    3.91156620e-06,0.00000000e+00]))

    S3B_OLCI_17 = (109, 0.849912, 0.879912, 
                    np.array([0.00000000e+00,9.59434899e-06,2.14138817e-01,
                    9.99742090e-01,9.93258209e-01,9.85146581e-01,
                    9.76632095e-01,9.63166016e-01,9.48798116e-01,
                    9.34440754e-01,7.28031193e-01,1.66200586e-03,
                    0.00000000e+00]))

    S3B_OLCI_18 = (110, 0.873624, 0.893624, 
                    np.array([0.00000000e+00,7.13410937e-06,1.96138123e-01,
                    9.99783396e-01,9.85369838e-01,9.68975289e-01,
                    7.70282671e-01,1.99389844e-03,0.00000000e+00]))

    S3B_OLCI_19 = (111, 0.888629, 0.908629, 
                    np.array([0.00000000e+00,7.17898241e-06,1.96492559e-01,
                    9.99722659e-01,9.83210999e-01,9.62763544e-01,
                    7.63076330e-01,1.98079933e-03,0.00000000e+00]))

    S3B_OLCI_20 = (112, 0.926079, 0.956079, 
                    np.array([4.26238134e-06,1.60425222e-01,9.99906954e-01,
                    9.67842837e-01,9.33261023e-01,8.99173179e-01,
                    8.67548926e-01,8.42191983e-01,8.18701520e-01,
                    6.84721377e-01,2.74031822e-03,1.44022973e-09,
                    0.00000000e+00]))

    S3B_OLCI_21 = (113, 0.996136, 1.046136, 
                    np.array([1.56885754e-06,1.20681717e-01,9.99899144e-01,
                    9.47074427e-01,8.88091796e-01,8.29980381e-01,
                    7.72737183e-01,7.16003018e-01,6.59334397e-01,
                    6.03472531e-01,5.60279317e-01,5.30809009e-01,
                    5.01348014e-01,4.72285721e-01,4.44131508e-01,
                    4.16773690e-01,3.90065100e-01,3.23255974e-01,
                    7.89325317e-04,1.54291637e-10,0.00000000e+00]))
